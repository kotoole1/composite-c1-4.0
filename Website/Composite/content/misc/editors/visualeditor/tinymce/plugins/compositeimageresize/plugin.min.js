		...
		*/
		init: function (ed, url) {
			...
			function removeResizeHandler() {
				if (selectedElm != null) {
					selectedElm.detachEvent('onresizestart', resizeImageStart);
					selectedElm.detachEvent('onresizeend', resizeImageEnd);
					selectedElm = null;
				}
			}
			...
			function setResizeHandler(controlElm) {
				if (Uri.isMedia(controlElm.src)) {
					...
					selectedElm.attachEvent('onresizestart', resizeImageStart);
					selectedElm.attachEvent('onresizeend', resizeImageEnd);
				} else {
